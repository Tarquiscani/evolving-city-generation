...
//"EDGEABLE_IDS" definition has been automatically declared in shader.cpp
    ...
    out vec2 vs_section_sprite_coords;
    out vec2 vs_corner_shadow_sprite_coords;
    flat out uint vs_background_sprite_layer;
    flat out uint vs_section_sprite_layer;
    flat out uint vs_corner_shadow_sprite_layer;
#else
    out vec3 vs_world_pos;
...
void main()
{
    ...
    vs_section_sprite_coords = VAO_section_sprite_coords;
    vs_corner_shadow_sprite_coords = VAO_corner_shadow_sprite_coords;
    vs_background_sprite_layer = VAO_background_sprite_layer;
    vs_section_sprite_layer = VAO_section_sprite_layer;
    vs_corner_shadow_sprite_layer = VAO_corner_shadow_sprite_layer;
#else
