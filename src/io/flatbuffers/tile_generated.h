...
#ifndef FLATBUFFERS_GENERATED_TILE_TGMSCHEMA_H_
#define FLATBUFFERS_GENERATED_TILE_TGMSCHEMA_H_
...
struct Tile FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const tgmschema::TileBuildingInfo *> *building_infos() const {
    return GetPointer<const flatbuffers::Vector<const tgmschema::TileBuildingInfo *> *>(VT_BUILDING_INFOS);
  }
  tgmschema::TileType type() const {
    return static_cast<tgmschema::TileType>(GetField<int16_t>(VT_TYPE, 0));
  }
  tgmschema::BorderStyle border_style() const {
    return static_cast<tgmschema::BorderStyle>(GetField<int16_t>(VT_BORDER_STYLE, 0));
  }
  const flatbuffers::Vector<const tgmschema::RoofInfo *> *roof_infos() const {
    return GetPointer<const flatbuffers::Vector<const tgmschema::RoofInfo *> *>(VT_ROOF_INFOS);
  }
...
struct TileBuilder {
  ...
  void add_building_infos(flatbuffers::Offset<flatbuffers::Vector<const tgmschema::TileBuildingInfo *>> building_infos) {
    fbb_.AddOffset(Tile::VT_BUILDING_INFOS, building_infos);
  }
  void add_type(tgmschema::TileType type) {
    fbb_.AddElement<int16_t>(Tile::VT_TYPE, static_cast<int16_t>(type), 0);
  }
  void add_border_style(tgmschema::BorderStyle border_style) {
    fbb_.AddElement<int16_t>(Tile::VT_BORDER_STYLE, static_cast<int16_t>(border_style), 0);
  }
  void add_roof_infos(flatbuffers::Offset<flatbuffers::Vector<const tgmschema::RoofInfo *>> roof_infos) {
...
inline flatbuffers::Offset<Tile> CreateTile(
    ...
    flatbuffers::Offset<flatbuffers::Vector<const tgmschema::TileBuildingInfo *>> building_infos = 0,
    tgmschema::TileType type = tgmschema::TileType_none,
    tgmschema::BorderStyle border_style = tgmschema::BorderStyle_none,
    flatbuffers::Offset<flatbuffers::Vector<const tgmschema::RoofInfo *>> roof_infos = 0,
...
inline flatbuffers::Offset<Tile> CreateTileDirect(
    ...
    bool door_open = false,
    int8_t border_count = 0,
    const std::vector<tgmschema::TileBuildingInfo> *building_infos = nullptr,
    tgmschema::TileType type = tgmschema::TileType_none,
    tgmschema::BorderStyle border_style = tgmschema::BorderStyle_none,
    const std::vector<tgmschema::RoofInfo> *roof_infos = nullptr,
    uint64_t furniture_id = 0,
    int16_t hosted_mobiles = 0) {
  auto building_infos__ = building_infos ? _fbb.CreateVectorOfStructs<tgmschema::TileBuildingInfo>(*building_infos) : 0;
  auto roof_infos__ = roof_infos ? _fbb.CreateVectorOfStructs<tgmschema::RoofInfo>(*roof_infos) : 0;
  return tgmschema::CreateTile(
      _fbb,
      inner_area,
      block,
      door,
...
#endif  // FLATBUFFERS_GENERATED_TILE_TGMSCHEMA_H_
