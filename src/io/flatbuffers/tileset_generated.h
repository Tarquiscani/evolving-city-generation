...
#ifndef FLATBUFFERS_GENERATED_TILESET_TGMSCHEMA_H_
#define FLATBUFFERS_GENERATED_TILESET_TGMSCHEMA_H_
...
struct TileWrapper FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const tgmschema::Vector3i *pos() const {
    return GetStruct<const tgmschema::Vector3i *>(VT_POS);
  }
  const tgmschema::Tile *t() const {
    return GetPointer<const tgmschema::Tile *>(VT_T);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<tgmschema::Vector3i>(verifier, VT_POS, 4) &&
...
struct TileWrapperBuilder {
  ...
  void add_pos(const tgmschema::Vector3i *pos) {
    fbb_.AddStruct(TileWrapper::VT_POS, pos);
  }
  void add_t(flatbuffers::Offset<tgmschema::Tile> t) {
...
inline flatbuffers::Offset<TileWrapper> CreateTileWrapper(
    ...
    const tgmschema::Vector3i *pos = nullptr,
    flatbuffers::Offset<tgmschema::Tile> t = 0) {
...
struct TileSet FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<tgmschema::TileWrapper>> *tiles() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<tgmschema::TileWrapper>> *>(VT_TILES);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct TileSetBuilder {
  ...
  void add_tiles(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<tgmschema::TileWrapper>>> tiles) {
...
inline flatbuffers::Offset<TileSet> CreateTileSet(
    ...
    int32_t width = 0,
    int32_t height = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<tgmschema::TileWrapper>>> tiles = 0) {
...
inline flatbuffers::Offset<TileSet> CreateTileSetDirect(
    ...
    int32_t width = 0,
    int32_t height = 0,
    const std::vector<flatbuffers::Offset<tgmschema::TileWrapper>> *tiles = nullptr) {
  auto tiles__ = tiles ? _fbb.CreateVector<flatbuffers::Offset<tgmschema::TileWrapper>>(*tiles) : 0;
  return tgmschema::CreateTileSet(
      _fbb,
      length,
      width,
      height,
...
#endif  // FLATBUFFERS_GENERATED_TILESET_TGMSCHEMA_H_
